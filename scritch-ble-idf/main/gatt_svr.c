...
// 定義 GATT Notify 的 characteristic handle
uint16_t my_characteristic_handle;

// 函數原型
static int gatt_svr_chr_access_my_characteristic(uint16_t conn_handle,
                                                  uint16_t attr_handle,
                                                  struct ble_gatt_access_ctxt *ctxt,
                                                  void *arg);

uint8_t my_characteristic_value = 0;
